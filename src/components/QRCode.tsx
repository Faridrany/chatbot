      ...
      <div className="w-full max-w-2xl mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-2xl p-12 border border-green-100">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-gradient-to-br from-[#2E7D32] to-[#4CAF50] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
          ...
          {/* QR Code Container */}
          <div className="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 mb-8 border-2 border-dashed border-[#A5D6A7]">
          ...
          <div className="bg-green-50 rounded-xl p-6 mb-8 border border-green-200">
            ...
            <ol className="space-y-2 text-gray-700">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[#2E7D32] text-white rounded-full flex items-center justify-center text-sm">1</span>
                <span>Buka aplikasi WhatsApp di ponsel Anda</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[#2E7D32] text-white rounded-full flex items-center justify-center text-sm">2</span>
                <span>Pilih menu "Perangkat Tertaut" atau "Linked Devices"</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[#2E7D32] text-white rounded-full flex items-center justify-center text-sm">3</span>
                <span>Scan QR Code yang ditampilkan di atas</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-[#2E7D32] text-white rounded-full flex items-center justify-center text-sm">4</span>
